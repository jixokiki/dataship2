...
public class POBarangAdapter extends RecyclerView.Adapter<POBarangAdapter.BarangViewHolder> {
    ...
    public POBarangAdapter(List<Barang> barangList, OnItemCheckListener onItemCheckListener) {
    ...
    public BarangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_barang_process2, parent, false);
