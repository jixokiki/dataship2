...
public class POApproveAdapter extends RecyclerView.Adapter<POApproveAdapter.BarangViewHolder> {
    ...
    public POApproveAdapter(List<Barang> barangList, OnItemCheckListener onItemCheckListener) {
    ...
    public BarangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_barang_approve, parent, false);
